...
\hypertarget{cpp__future_8hpp_source}{}\label{cpp__future_8hpp_source}\index{include/nlohman/json-\/develop/include/nlohmann/detail/meta/cpp\_future.hpp@{include/nlohman/json-\/develop/include/nlohmann/detail/meta/cpp\_future.hpp}}
...
\DoxyCodeLine{00065\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}}
\DoxyCodeLine{00066\ \{}
...
\DoxyCodeLine{00080\ \textcolor{keyword}{using\ }index\_sequence\ =\ \doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<size\_t,\ Ints...>;}
\DoxyCodeLine{00081\ }
...
\DoxyCodeLine{00086\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_extend}{Extend}};}
\DoxyCodeLine{00087\ }
...
\DoxyCodeLine{00090\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_extend}{Extend}}<\doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<T,\ Ints...>,\ SeqSize,\ 0>}
\DoxyCodeLine{00091\ \{}
\DoxyCodeLine{00092\ \ \ \ \ \textcolor{keyword}{using\ }type\ =\ \doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}\ <\ T,\ Ints...,\ (Ints\ +\ SeqSize)...\ >;}
\DoxyCodeLine{00093\ \};}
\DoxyCodeLine{00094\ }
\DoxyCodeLine{00095\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T,\ T...\ Ints,\ \textcolor{keywordtype}{size\_t}\ SeqSize>}
\DoxyCodeLine{00096\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_extend}{Extend}}<\doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}<T,\ Ints...>,\ SeqSize,\ 1>}
\DoxyCodeLine{00097\ \{}
\DoxyCodeLine{00098\ \ \ \ \ \textcolor{keyword}{using\ }type\ =\ \doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence}}\ <\ T,\ Ints...,\ (Ints\ +\ SeqSize)...,\ 2\ *\ SeqSize\ >;}
\DoxyCodeLine{00099\ \};}
\DoxyCodeLine{00100\ }
...
\DoxyCodeLine{00104\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_gen}{Gen}}}
\DoxyCodeLine{00105\ \{}
\DoxyCodeLine{00106\ \ \ \ \ \textcolor{keyword}{using\ }type\ =}
\DoxyCodeLine{00107\ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_extend}{Extend}}\ <\ \textcolor{keyword}{typename}\ \doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_gen}{Gen}}\ <\ T,\ N\ /\ 2\ >::type,\ N\ /\ 2,\ N\ \%\ 2\ >::type;}
\DoxyCodeLine{00108\ \};}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00111\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1utility__internal_1_1_gen}{Gen}}<T,\ 0>}
\DoxyCodeLine{00112\ \{}
\DoxyCodeLine{00113\ \ \ \ \ \textcolor{keyword}{using\ }type\ =\ \doxymbox{\hyperlink{structdetail_1_1integer__sequence}{integer\_sequence<T>}};}
\DoxyCodeLine{00114\ \};}
\DoxyCodeLine{00115\ }
...
\DoxyCodeLine{00149\ \textcolor{keyword}{template}<\textcolor{keywordtype}{unsigned}\ N>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1priority__tag}{priority\_tag}}\ :\ \doxymbox{\hyperlink{structdetail_1_1priority__tag}{priority\_tag}}\ <\ N\ -\/\ 1\ >\ \{\};}
\DoxyCodeLine{00150\ \textcolor{keyword}{template}<>\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1priority__tag}{priority\_tag}}<0>\ \{\};}
\DoxyCodeLine{00151\ }
...
\DoxyCodeLine{00154\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structdetail_1_1static__const}{static\_const}}}
\DoxyCodeLine{00155\ \{}
...
\DoxyCodeLine{00165\ \textcolor{keyword}{constexpr}\ std::array<T,\ \textcolor{keyword}{sizeof}...(Args)>\ make\_array(Args\&\&\ ...\ args)}
\DoxyCodeLine{00166\ \{}

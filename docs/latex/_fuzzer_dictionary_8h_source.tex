...
\hypertarget{_fuzzer_dictionary_8h_source}{}\label{_fuzzer_dictionary_8h_source}\index{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerDictionary.h@{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerDictionary.h}}
...
\DoxyCodeLine{00026\ \ \ FixedWord(\textcolor{keyword}{const}\ uint8\_t\ *\doxymbox{\hyperlink{class_b}{B}},\ uint8\_t\ S)\ \{\ Set(\doxymbox{\hyperlink{class_b}{B}},\ S);\ \}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \ \ \textcolor{keywordtype}{void}\ Set(\textcolor{keyword}{const}\ uint8\_t\ *\doxymbox{\hyperlink{class_b}{B}},\ uint8\_t\ S)\ \{}
\DoxyCodeLine{00029\ \ \ \ \ assert(S\ <=\ kMaxSize);}
\DoxyCodeLine{00030\ \ \ \ \ memcpy(Data,\ \doxymbox{\hyperlink{class_b}{B}},\ S);}
...
\DoxyCodeLine{00051\ \};}
\DoxyCodeLine{00052\ }
\DoxyCodeLine{00053\ \textcolor{keyword}{typedef}\ \doxymbox{\hyperlink{classfuzzer_1_1_fixed_word}{FixedWord<27>}}\ Word;\ \textcolor{comment}{//\ 28\ bytes.}}
\DoxyCodeLine{00054\ }
...
\DoxyCodeLine{00084\ \};}
\DoxyCodeLine{00085\ }
\DoxyCodeLine{00086\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_dictionary}{Dictionary}}\ \{}
...
\DoxyCodeLine{00091\ \ \ \ \ \textcolor{keywordflow}{return}\ std::any\_of(begin(),\ end(),\ [\&](\textcolor{keyword}{const}\ \doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ \&DE)\ \{}
\DoxyCodeLine{00092\ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ DE.GetW()\ ==\ W;}
\DoxyCodeLine{00093\ \ \ \ \ \});}
\DoxyCodeLine{00094\ \ \ \}}
\DoxyCodeLine{00095\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ *begin()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \&DE[0];\ \}}
\DoxyCodeLine{00096\ \ \ \textcolor{keyword}{const}\ \doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ *end()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ begin()\ +\ Size;\ \}}
\DoxyCodeLine{00097\ \ \ \doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ \&\ operator[]\ (\textcolor{keywordtype}{size\_t}\ Idx)\ \{}
\DoxyCodeLine{00098\ \ \ \ \ assert(Idx\ <\ Size);}
\DoxyCodeLine{00099\ \ \ \ \ \textcolor{keywordflow}{return}\ DE[Idx];}
\DoxyCodeLine{00100\ \ \ \}}
\DoxyCodeLine{00101\ \ \ \textcolor{keywordtype}{void}\ push\_back(\doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ DE)\ \{}
...
\DoxyCodeLine{00110\ \ \ \doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}}\ DE[kMaxDictSize];}

...
\hypertarget{_fuzzer_defs_8h_source}{}\label{_fuzzer_defs_8h_source}\index{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerDefs.h@{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerDefs.h}}
...
\DoxyCodeLine{00058\ }
\DoxyCodeLine{00059\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_random}{Random}};}
\DoxyCodeLine{00060\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_dictionary}{Dictionary}};}
\DoxyCodeLine{00061\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_dictionary_entry}{DictionaryEntry}};}
\DoxyCodeLine{00062\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_mutation_dispatcher}{MutationDispatcher}};}
\DoxyCodeLine{00063\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_fuzzing_options}{FuzzingOptions}};}
\DoxyCodeLine{00064\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_input_corpus}{InputCorpus}};}
\DoxyCodeLine{00065\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_input_info}{InputInfo}};}
\DoxyCodeLine{00066\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_external_functions}{ExternalFunctions}};}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \textcolor{comment}{//\ Global\ interface\ to\ functions\ that\ may\ or\ may\ not\ be\ available.}}
\DoxyCodeLine{00069\ \textcolor{keyword}{extern}\ \doxymbox{\hyperlink{structfuzzer_1_1_external_functions}{ExternalFunctions}}\ *EF;}
\DoxyCodeLine{00070\ }

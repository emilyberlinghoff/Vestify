...
\hypertarget{_fuzzer_interface_8h_source}{}\label{_fuzzer_interface_8h_source}\index{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerInterface.h@{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerInterface.h}}
...
\DoxyCodeLine{00033\ \textcolor{keywordtype}{int}\ LLVMFuzzerTestOneInput(\textcolor{keyword}{const}\ uint8\_t\ *\doxymbox{\hyperlink{struct_data}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size);}
\DoxyCodeLine{00034\ }
...
\DoxyCodeLine{00045\ \textcolor{keywordtype}{size\_t}\ LLVMFuzzerCustomMutator(uint8\_t\ *\doxymbox{\hyperlink{struct_data}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size,\ \textcolor{keywordtype}{size\_t}\ MaxSize,}
...
\DoxyCodeLine{00061\ \textcolor{keywordtype}{size\_t}\ LLVMFuzzerMutate(uint8\_t\ *\doxymbox{\hyperlink{struct_data}{Data}},\ \textcolor{keywordtype}{size\_t}\ Size,\ \textcolor{keywordtype}{size\_t}\ MaxSize);}
\DoxyCodeLine{00062\ }

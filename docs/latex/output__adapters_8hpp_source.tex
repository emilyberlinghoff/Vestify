...
\hypertarget{output__adapters_8hpp_source}{}\label{output__adapters_8hpp_source}\index{include/nlohman/json-\/develop/include/nlohmann/detail/output/output\_adapters.hpp@{include/nlohman/json-\/develop/include/nlohmann/detail/output/output\_adapters.hpp}}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{using\ }\doxymbox{\hyperlink{namespacedetail_a558c0470e929e42aad8be2527da6c033}{output\_adapter\_t}}\ =\ std::shared\_ptr<output\_adapter\_protocol<CharType>>;}
\DoxyCodeLine{00046\ }
...
\DoxyCodeLine{00077\ \ \ \ \ \textcolor{keyword}{explicit}\ output\_stream\_adapter(\doxymbox{\hyperlink{classstd_1_1basic__ostream}{std::basic\_ostream<CharType>}}\&\ s)\ noexcept}
...
\DoxyCodeLine{00093\ \ \ \ \ \doxymbox{\hyperlink{classstd_1_1basic__ostream}{std::basic\_ostream<CharType>}}\&\ stream;}
\DoxyCodeLine{00094\ \};}
...
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<\doxymbox{\hyperlink{classdetail_1_1output__vector__adapter}{output\_vector\_adapter<CharType,\ AllocatorType>}}>(vec))\ \{\}}
\DoxyCodeLine{00128\ }
\DoxyCodeLine{00129\ \textcolor{preprocessor}{\#ifndef\ JSON\_NO\_IO}}
\DoxyCodeLine{00130\ \ \ \ \ output\_adapter(\doxymbox{\hyperlink{classstd_1_1basic__ostream}{std::basic\_ostream<CharType>}}\&\ s)}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<\doxymbox{\hyperlink{classdetail_1_1output__stream__adapter}{output\_stream\_adapter<CharType>}}>(s))\ \{\}}
...
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ :\ oa(std::make\_shared<\doxymbox{\hyperlink{classdetail_1_1output__string__adapter}{output\_string\_adapter<CharType,\ StringType>}}>(s))\ \{\}}
\DoxyCodeLine{00136\ }
\DoxyCodeLine{00137\ \ \ \ \ \textcolor{keyword}{operator}\ \doxymbox{\hyperlink{namespacedetail_a558c0470e929e42aad8be2527da6c033}{output\_adapter\_t<CharType>}}()}
\DoxyCodeLine{00138\ \ \ \ \ \{}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ oa;}
\DoxyCodeLine{00140\ \ \ \ \ \}}
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00143\ \ \ \ \ \doxymbox{\hyperlink{namespacedetail_a558c0470e929e42aad8be2527da6c033}{output\_adapter\_t<CharType>}}\ oa\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00144\ \};}
\DoxyCodeLine{00145\ }

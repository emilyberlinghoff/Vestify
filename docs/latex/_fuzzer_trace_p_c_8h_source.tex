...
\hypertarget{_fuzzer_trace_p_c_8h_source}{}\label{_fuzzer_trace_p_c_8h_source}\index{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerTracePC.h@{include/nlohman/json-\/develop/tests/thirdparty/Fuzzer/FuzzerTracePC.h}}
...
\DoxyCodeLine{00029\ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_table_of_recent_compares}{TableOfRecentCompares}}\ \{}
\DoxyCodeLine{00030\ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ kSize\ =\ kSizeT;}
\DoxyCodeLine{00031\ \ \ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_table_of_recent_compares_1_1_pair}{Pair}}\ \{}
...
\DoxyCodeLine{00043\ \};}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classfuzzer_1_1_trace_p_c}{TracePC}}\ \{}
...
\DoxyCodeLine{00059\ \ \ \textcolor{keywordtype}{bool}\ UpdateValueProfileMap(\doxymbox{\hyperlink{structfuzzer_1_1_value_bit_map}{ValueBitMap}}\ *MaxValueProfileMap)\ \{}
...
\DoxyCodeLine{00084\ \ \ \doxymbox{\hyperlink{structfuzzer_1_1_table_of_recent_compares}{TableOfRecentCompares<uint32\_t,\ kTORCSize>}}\ TORC4;}
\DoxyCodeLine{00085\ \ \ \doxymbox{\hyperlink{structfuzzer_1_1_table_of_recent_compares}{TableOfRecentCompares<uint64\_t,\ kTORCSize>}}\ TORC8;}
\DoxyCodeLine{00086\ }
...
\DoxyCodeLine{00098\ }
\DoxyCodeLine{00099\ \ \ \textcolor{keyword}{struct\ }\doxymbox{\hyperlink{structfuzzer_1_1_trace_p_c_1_1_module}{Module}}\ \{}
\DoxyCodeLine{00100\ \ \ \ \ uint32\_t\ *Start,\ *Stop;}
\DoxyCodeLine{00101\ \ \ \};}
\DoxyCodeLine{00102\ }
\DoxyCodeLine{00103\ \ \ \doxymbox{\hyperlink{structfuzzer_1_1_trace_p_c_1_1_module}{Module}}\ Modules[4096];}
...
\DoxyCodeLine{00114\ }
\DoxyCodeLine{00115\ \ \ \doxymbox{\hyperlink{structfuzzer_1_1_value_bit_map}{ValueBitMap}}\ ValueProfileMap;}
\DoxyCodeLine{00116\ \};}
\DoxyCodeLine{00117\ }
...
\DoxyCodeLine{00130\ \ \ \ \ \ \ uint8\_t\ Counter\ =\ (Bundle\ >>\ ((i\ -\/\ Idx)\ *\ 8))\ \&\ 0xff;}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (!Counter)\ \textcolor{keywordflow}{continue};}
\DoxyCodeLine{00132\ \ \ \ \ \ \ Counters[i]\ =\ 0;}
\DoxyCodeLine{00133\ \ \ \ \ \ \ \textcolor{keywordtype}{unsigned}\ Bit\ =\ 0;}
\DoxyCodeLine{00134\ \ \ \ \ \ \ \textcolor{comment}{/**/}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 128)\ Bit\ =\ 7;}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 32)\ Bit\ =\ 6;}
\DoxyCodeLine{00136\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 16)\ Bit\ =\ 5;}
\DoxyCodeLine{00137\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 8)\ Bit\ =\ 4;}
\DoxyCodeLine{00138\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 4)\ Bit\ =\ 3;}
\DoxyCodeLine{00139\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 3)\ Bit\ =\ 2;}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (Counter\ >=\ 2)\ Bit\ =\ 1;}
...
\DoxyCodeLine{00152\ \}}
\DoxyCodeLine{00153\ }
\DoxyCodeLine{00154\ \textcolor{keyword}{extern}\ \doxymbox{\hyperlink{classfuzzer_1_1_trace_p_c}{TracePC}}\ TPC;}
\DoxyCodeLine{00155\ }
